...
public:
    int countDigitOne(int n) {
        ...
        //   当前位>1 => (高位数字+1)*当前位基数，比如2230的百位（100、...、199、1100、...、1199、2100、...、2199）=> (2+1)*100
        //   当前位=1 => 高位数字*当前位基数+低位数字+1，比如2125的百位（100、...、199、1100、...、1199、2100、...、2125）=> 2*100+26
        //   当前位=0 => 高位数字*当前位基数，比如2017的百位（100、...、199、1100、...、1199）=> 2*100
        if (n <= 0) return 0;
        int count = 0;
        int base = 1;
        while (true) {
